...
CREATE TABLE `bestelling_detail` (
  ...
  `factuur_code` int(10) DEFAULT NULL,
  ...
  KEY `factuurCode_idx` (`factuur_code`),
  CONSTRAINT `factuurCode` FOREIGN KEY (`factuur_code`) REFERENCES `factuur` (`factuur_code`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=70 DEFAULT CHARSET=utf8 COMMENT='Extra informatie over de recente bestelling, zoals Verzenden, Ophalen, Kosten.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `bestelling_detail` VALUES (1,NULL,'=fb27aee1-ee47-4904-adc9-95ac1e3f0f35','ophalen','nee'),(2,NULL,'=b6b4db9d-757c-49bc-b756-bab5081e0728','ophalen','nee'),(3,NULL,'=b6b4db9d-757c-49bc-b756-bab5081e0728','ophalen','nee'),(4,NULL,'=8c929d30-b327-47e6-994d-5a0ebb5d14f4','ophalen','nee'),(57,NULL,'=5e154bcd-653b-43b2-8eef-4c7b7b48103d','verzenden','nee'),(58,NULL,'=5e154bcd-653b-43b2-8eef-4c7b7b48103d','verzenden','nee'),(59,NULL,'=5e154bcd-653b-43b2-8eef-4c7b7b48103d','verzenden','nee'),(60,NULL,'=7af52724-cc91-4a97-b512-049fd26f6645','ophalen','nee'),(61,NULL,'=52625c39-f0c6-4ab9-85d5-cc301e797252','ophalen','nee'),(62,NULL,'=e9dc3875-8368-4d3b-89cd-d6aad18b953f','ophalen','nee'),(63,NULL,'=e9dc3875-8368-4d3b-89cd-d6aad18b953f','ophalen','nee'),(64,NULL,'=e9dc3875-8368-4d3b-89cd-d6aad18b953f','ophalen','nee'),(65,NULL,'=eed67e4d-7be1-428e-933b-a588ecccc4d4','ophalen','nee'),(66,91,'=ebf99bf2-89b4-4770-ad87-3555b1d3b7d4','ophalen','nee'),(67,91,'=ebf99bf2-89b4-4770-ad87-3555b1d3b7d4','ophalen','nee'),(68,93,'=996b223a-e45c-41d7-a33e-8e0e241b39d1','ophalen','nee'),(69,94,'=996b223a-e45c-41d7-a33e-8e0e241b39d1','ophalen','nee');
...
-- Dump completed on 2015-05-03 23:07:13
